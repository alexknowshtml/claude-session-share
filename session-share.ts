...
<body>
  ...
  <div class="page">
    ...
    <div class="page-footer"><span class="footer-mark">A</span> Claude Code Session Share · <a href="https://jfdi.bot" target="_blank" rel="noopener" style="color:var(--yellow);text-decoration:none;">jfdi.bot</a></div>
  </div>
</body>
</html>`;
}
